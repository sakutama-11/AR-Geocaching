...
namespace Immersal.Samples
{
    ...
    public class MapListController : MonoBehaviour
    {
        ...
        [SerializeField]
        private ContentPlacement.ContentStorageManager m_ContentManager;
        ...
        public void LoadMap(SDKJob job)
        {
            ...
            j.OnResult += (SDKMapResult result) =>
            {
                ...
                m_ContentManager.m_ARSpace = UnityEngine.Object.FindObjectOfType<ARSpace>();
                m_ContentManager.LoadContents();
            };
